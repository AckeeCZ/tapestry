...
let config = TapestryConfig(
    release: Release(actions: [.pre(.docsUpdate),
                               ...
                               // Mint support
                                ...
                                .pre(tool: "cp", arguments: [".build/release/libPackageDescription.dylib"]),
                                .pre(tool: "cp", arguments: [".build/release/PackageDescription.swiftmodule"]),
                                .pre(tool: "cp", arguments: [".build/release/PackageDescription.swiftdoc"])],
                     add: ["README.md",
                           "CHANGELOG.md",
