...
public protocol Printing: AnyObject {
    ...
    func print(_ text: String, includeNewline: Bool)
...
public class Printer: Printing {
    ...
    public func print(_ text: String, includeNewline: Bool) {
        printStandardOutputLine(text, includeNewline: includeNewline)
    }
    ...
    fileprivate func printStandardOutputLine(_ string: String, includeNewline: Bool = true) {
