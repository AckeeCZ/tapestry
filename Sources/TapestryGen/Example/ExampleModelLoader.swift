...
public final class ExampleModelLoader: GeneratorModelLoading {
    ...
    public func loadProject(at path: AbsolutePath) throws -> Project {
        ...
        return Project(path: path, name: name, settings: .default, filesGroup: .group(name: name), targets: [Target(name: name, platform: .macOS, product: .app, productName: nil, bundleId: bundleId, sources: sources, filesGroup: .group(name: name), dependencies: [.package(.remote(url: <#T##String#>, productName: <#T##String#>, versionRequirement: <#T##Dependency.VersionRequirement#>))])], schemes: [])
    }
